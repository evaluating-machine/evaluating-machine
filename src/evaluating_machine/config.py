...
settings = dict(
    ...
    machine_organization_name   = environ.get('MACHINE_ORGANIZATION_NAME', 'evaluating-machine'),
    private_repo_with_text      = environ.get('PRIVATE_REPO_WITH_TEXT','evaluating_machine'),
